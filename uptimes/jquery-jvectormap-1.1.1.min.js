...
function(e) {
    function r(t) {
        ...
        u = i,
        n.axis !== undefined && n.axis === n.HORIZONTAL_AXIS && (u = 0,
        o = -1 * i),
...
jvm.AbstractShapeElement.prototype.updateStyle = function() {
    ...
    this.isSelected && (jvm.$.extend(e, this.style.selected || {}),
...
jvm.DataSeries = function(e, t) {
    ...
    jvm.$.isArray(e.scale) ? (n = e.attribute === "fill" || e.attribute === "stroke" ? jvm.ColorScale : jvm.NumericScale,
    this.scale = new n(e.scale,e.normalizeFunction,e.min,e.max)) : e.scale ? this.scale = new jvm.OrdinalScale(e.scale) : this.scale = new jvm.SimpleScale(e.scale),
    e.values && (this.values = e.values || {},
...
jvm.WorldMap.prototype = {
    ...
    applyTransform: function() {
        ...
        this.defaultHeight * this.scale <= this.height ? (t = (this.height - this.defaultHeight * this.scale) / (2 * this.scale),
    ...
    bindContainerEvents: function() {
        ...
        this.container.mousemove(function(i) {
            return e && (r.transX -= (t - i.pageX) / r.scale,
    ...
    bindContainerTouchEvents: function() {
        ...
        jvm.$(this.container).bind("touchstart", function(e) {
            ...
            t.length == 2 && (t[0].pageX > t[1].pageX ? o = t[1].pageX + (t[0].pageX - t[1].pageX) / 2 : o = t[0].pageX + (t[1].pageX - t[0].pageX) / 2,
            t[0].pageY > t[1].pageY ? u = t[1].pageY + (t[0].pageY - t[1].pageY) / 2 : u = t[0].pageY + (t[1].pageY - t[0].pageY) / 2),
        ...
        jvm.$(this.container).bind("touchmove", function(e) {
            ...
            if (r.scale != r.baseScale)
                return e.originalEvent.touches.length == 1 && i && s ? (t = e.originalEvent.touches[0],
    ...
    bindElementEvents: function() {
        ...
        this.container.delegate("[class~='jvectormap-element']", "mouseover mouseout", function(t) {
            ...
            t.type == "mouseover" ? (e.container.trigger(a, [i]),
            a.isDefaultPrevented() || s.setHovered(!0),
            e.label.text(o),
            e.container.trigger(u, [e.label, i]),
            u.isDefaultPrevented() || (e.label.show(),
            e.labelWidth = e.label.width(),
            e.labelHeight = e.label.height())) : (s.setHovered(!1),
            e.label.hide(),
        ...
        this.container.delegate("[class~='jvectormap-element']", "mouseup", function(n) {
            ...
            if (!t) {
                ...
                if (i === "region" && e.params.regionsSelectable || i === "marker" && e.params.markersSelectable)
                    o.isDefaultPrevented() || (e.params[i + "sSelectableOne"] && e.clearSelected(i + "s"),
    ...
    setScale: function(e, t, n, r) {
        ...
        typeof t != "undefined" && typeof n != "undefined" && (i = e / this.scale,
        r ? (this.transX = t + this.defaultWidth * (this.width / (this.defaultWidth * e)) / 2,
    ...
    setFocus: function(e, t, n) {
        var r;
        typeof e == "string" && this.regions[e] ? (r = this.regions[e].element.getBBox(),
        this.setScale(Math.min(this.width / r.width, this.height / r.height), -(r.x + r.width / 2), -(r.y + r.height / 2), !0)) : this.setScale(e, -t * this.defaultWidth, -n * this.defaultHeight, !0)
    },
